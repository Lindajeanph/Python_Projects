...
def getdestination(self):
    ...
    dest.entrydestination.delete(0, END)
    dest.entrydestination.insert(END, retrieve)
...
def loadgui(self):
    ...
    self.go.grid(row=4, column=0,padx=(30,0), pady=(50,0), sticky=W)
    self.b3_label.grid(row= 0, column=0, padx=(30,0), pady=(5,0), sticky=W)
